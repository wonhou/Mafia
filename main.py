...
- 말투는 대한민국의 20대 사람들처럼 자연스럽고 인터넷이나 일상생활에서 자주 사용하는 단어 위주로 사용합니다.
- 같은 단어의 반복은 줄이고, 1~3문장으로 말하세요.
"""
...
참고: 당신이 과거에 말한 내용은 다음과 같습니다. 그리고 자신이 했던 말은 무조건 기억하고 참고해서 발언을 해야 합니다:
{self_text}
"""
    prompt += f"""
